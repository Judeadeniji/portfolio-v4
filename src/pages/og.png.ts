  ...
  const element = React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('span', {}, `./portfolio.sh`)
      ),
      React.createElement('span', { style: { color: '#a1a1aa' } }, `[Product Engineer]`)
    ),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('span', { style: { fontSize: '22px', color: '#a1a1aa' } }, author.twitterHandle ? `@${author.twitterHandle}` : 'Product Engineer')
        )
      ),
      // URL or Git
      React.createElement(
